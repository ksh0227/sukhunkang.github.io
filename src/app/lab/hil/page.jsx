        ...
        <main className="flex-grow px-6 lg:px-72 py-8">
          <section className="mt-8">
            ...
            <ul className="list-disc list-outside pl-6 mt-2 space-y-1">
              <li>
               Health Innovation Lab is co-directed by Dr. Sukhun Kang, <a href="https://www.barbosu.com/" className="underline">Dr. Sandra Barbosu</a>, and <a href="https://www.https://sungyongchang.com/" className="underline">Dr. Sungyong Chang.</a>
              </li>
              <li>
